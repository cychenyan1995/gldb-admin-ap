package com.glsx.oms.bigdata.admin.ap.aspect;
...
import com.glsx.oms.bigdata.admin.ap.vo.RespStatusEnum;
...
public class SystemAspect {
     ...
     * @Return void
     */
    @Pointcut("execution (* com.glsx.oms.bigdata.admin.ap.controller..*.*(..))")
